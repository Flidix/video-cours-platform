...
export class CreatebuedCoursesEntity1692187475350 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "buedCourses" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "fromUserId" integer, "coursId" integer, CONSTRAINT "PK_f5daa124c52e6f1d52e488ab21a" PRIMARY KEY ("id"))`);

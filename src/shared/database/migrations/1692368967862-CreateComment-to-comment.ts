...
export class CreateCommentToComment1692368967862 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "commentsToComments" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "comment" character varying NOT NULL, "userId" integer NOT NULL, "fromUserId" integer, "toCommentId" integer, CONSTRAINT "PK_315883f2bdfef91788fde069e35" PRIMARY KEY ("id"))`);
